	...
	var TextAdd = function(){
		...
		if ($(this).is('.mquant')){
			...
			$('.qcontrol',$parent).click(function(){
				if ($(this).is('.qinc')) {$input.attr('value',$input.val()*1+1);}
