...
function reload_products()
{
	...
	{
		category =  topID || 0;
		$(".tag-filter-item[data-tag-box=1]").hide();
	}else{
		$(".tag-filter-item[data-tag-box=1]").show();
	}
	...
	if(brands.toString() != "") {
		...
		$(".tag-filter-item[data-tag-box=2]").show();
	}else{
		$(".tag-filter-item[data-tag-box=2]").hide();
	}
	var sizes = new Array;	
	$('.size-box').find("input").each(function(){
		...
		if(sizes.toString() != "") {
			...
			//$(".tag-filter-item[data-tag-box=3]").show();
		}else{
			//$(".tag-filter-item[data-tag-box=3]").hide();
		}
    var color = new Array;
	...
	if(color.toString() != "") {
		...
		//$(".tag-filter-item[data-tag-box=4]").show();
	}else{
		//$(".tag-filter-item[data-tag-box=4]").hide();
	}
	...
	if(season.toString() != "") {
		...
		//$(".tag-filter-item[data-tag-box=5]").show();
	}else{
		//$(".tag-filter-item[data-tag-box=5]").hide();
	}
	...
	var goods_groups = new Array;
	$('.goods_groups').find("input").each(function(){
		if($(this).is(':checked')){
			goods_groups.push($(this).attr("id"));
		}
	});
	if(goods_groups.toString() != "") {
		url = url + "&goods_groups=" + goods_groups.toString();
	}
	var sales = $('.sales').find("input").is(":checked") ? 1 : 0;
	if(sales!=""){
		url = url + "&sales=" + sales;
	}
	//alert(url);
...
function init_goods_groups(){
	$('.goods_groups').find("input[type=checkbox]").change(function(){
		reload_products();
	})
}
function init_sales(){
	$('.sales').find("input[type=checkbox]").change(function(){
		reload_products();
	})
}
