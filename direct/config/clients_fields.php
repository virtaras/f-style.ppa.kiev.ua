...
$controls["in_register"] = new Control("in_register","checkbox","Использовать при регистрации");


$source = "SELECT clients_fields.id,clients_fields.title,clients_fields.code,clients_fields.items,clients_fields.isrequired,
clients_fields.showorder,order_fields.title as order_field
FROM clients_fields
LEFT JOIN order_fields ON order_fields.id = clients_fields.order_field
";
